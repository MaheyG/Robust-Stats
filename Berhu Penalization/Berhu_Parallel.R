#Compute the Berhu Penalization with Least square of Huber Loss with the help of parallel package

Berhu_Parallel<-function(X,y,M=1.345,L=1,lambda,
                              loss=c("Huber","Least Square"),pena=c("Berhu","Elastic Net"),
                              nlambda=10,lambda_min=0.003,lambda_max,ncore=1,alpha=1){
